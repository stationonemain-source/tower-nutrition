...
RAW=$(higgsfield generate create kling3_0_turbo --prompt "$PROMPT" --start-image "$START" --duration 5 --resolution 720p --aspect_ratio 16:9 --wait --wait-timeout 20m --wait-interval 6s --json 2>&1)
